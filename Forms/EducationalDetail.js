                        ...
                        <View style={{marginBottom: 30}}>
                            <View style={{height: 52, marginTop: 33, marginHorizontal: 25, backgroundColor: "white"}}>
                                <TextInput style={{backgroundColor: "white"}} activeOutlineColor="#3E66FB"
                                           placeholder="Degree Title" label="Degree Title" mode="outlined">
                                </TextInput>
                            </View>
                            ...
                            <View style={{height: 52, marginTop: 33, marginHorizontal: 25}}>
                                <TextInput style={{backgroundColor: "white"}} activeOutlineColor="#3E66FB"
                                           onChangeText={text => setSelected(text) || setcheck(false)}
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{
                                    ...
                                    <TextInput.Icon onPress={() => navigation.navigate("AddOtherDetail")}
                                                    name={() => <Ionicons color="#8083A3" name="ios-chevron-back"
                                                                          size={20}/>}/>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => navigation.navigate("AddOtherDetail")} style={{
                                    alignItems: "center",
                                    justifyContent: "center",
                                    height: 46,
                                    width: "55%",
